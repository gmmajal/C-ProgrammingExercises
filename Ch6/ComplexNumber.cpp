 ...
 *7) An additional method overloading the binary multiplication operator
 *   in order to help with the complex matrix exponential.
 * */
...
ComplexNumber ComplexNumber::operator*(const ComplexNumber& z)const{
   ...
   w.mImaginaryPart = (z.mRealPart*mImaginaryPart) + (mRealPart*z.mImaginaryPart);
   return w;
}
